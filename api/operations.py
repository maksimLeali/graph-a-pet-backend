...
query.set_field("listOperationalShelterTasks", list_operational_shelter_tasks_resolver)
query.set_field("getShelterWalk", get_shelter_walk_resolver)
query.set_field("listShelterWalks", list_shelter_walks_resolver)
query.set_field("listOperationalShelterWalks", list_operational_shelter_walks_resolver)
...
query.set_field("getMyShelterDashboard", get_my_shelter_dashboard_resolver)
...
mutation.set_field("createShelterPetsWithData", create_shelter_pets_with_data_resolver)
mutation.set_field("changeShelter", change_shelter_resolver)
mutation.set_field("deleteShelterPet", delete_shelter_pet_resolver)
mutation.set_field("setShelterPetAssignees", set_shelter_pet_assignees_resolver)
mutation.set_field("setShelterPetPublished", set_shelter_pet_published_resolver)
...
mutation.set_field("archiveShelterInventoryItem", archive_shelter_inventory_item_resolver)
